// Current Mongosh Log ID:	6778ea563279f5a8e6fe6910
// Connecting to:		mongodb://<credentials>@m1,m2,m3/?appName=mongosh+2.3.2
...
//    2025-01-01T22:20:27.329+09:00: Using the XFS filesystem is strongly recommended with the WiredTiger storage engine. See http://dochub.mongodb.org/core/prodnotes-filesystem
// ------

// Enterprise sccamp [primary] test> switched to db shipdb
// Enterprise sccamp [primary] shipdb>
{
  ok: 1,
  capped: false,
  wiredTiger: {
    ...
    type: 'file',
    uri: 'statistics:table:collection-37-7440438102761067881',
    LSM: {
    ...
    'block-manager': {
      'allocations requiring file extension': 7364,
      'blocks allocated': 7692,
      'blocks freed': 348,
      'checkpoint size': 187990016,
      'file allocation unit size': 4096,
      'file bytes available for reuse': 1732608,
      'file magic number': 120897,
      'file major version number': 1,
      'file size in bytes': 189739008,
      'minor version number': 0
    },
    btree: {
      'btree checkpoint generation': 2086,
      ...
      'btree number of pages reconciled during checkpoint': 10,
    ...
    cache: {
      'bytes currently in the cache': 239225529,
      'bytes dirty in the cache cumulative': 10788976,
      'bytes read into cache': 311842188,
      'bytes written from cache': 368795235,
      ...
      'eviction walk passes of a file': 4350,
      'eviction walk target pages histogram - 0-9': 364,
      'eviction walk target pages histogram - 10-31': 893,
      'eviction walk target pages histogram - 128 and higher': 0,
      'eviction walk target pages histogram - 32-63': 1261,
      'eviction walk target pages histogram - 64-128': 1832,
      'eviction walk target pages reduced due to history store cache pressure': 0,
      'eviction walks abandoned': 36,
      'eviction walks gave up because they restarted their walk twice': 660,
      'eviction walks gave up because they saw too many pages and found no candidates': 162,
      'eviction walks gave up because they saw too many pages and found too few candidates': 61,
      'eviction walks random search fails to locate a page, results in a null position': 0,
      'eviction walks reached end of tree': 1587,
      'eviction walks restarted': 0,
      'eviction walks started from root of tree': 919,
      'eviction walks started from saved location in tree': 3431,
      ...
      'pages read into cache': 6260,
      'pages read into cache after truncate': 0,
      'pages read into cache after truncate in prepare state': 0,
      'pages requested from the cache': 270024,
      'pages seen by eviction walk': 1998960,
      'pages written from cache': 7680,
      'pages written requiring in-memory restoration': 80,
    ...
    cursor: {
      ...
      'cache cursors reuse count': 3998,
      'close calls that result in cache': 4002,
      'create calls': 7,
      ...
      'insert calls': 250000,
      'insert key and value bytes': 351610618,
      modify: 0,
    ...
    reconciliation: {
      ...
      'approximate byte size of timestamps in pages written': 4086720,
      'approximate byte size of transaction IDs in pages written': 2043360,
      'dictionary matches': 0,
      'fast-path pages deleted': 0,
      'internal page key bytes discarded using suffix compression': 14861,
      'internal page multi-block writes': 6,
      'leaf page key bytes discarded using prefix compression': 0,
      'leaf page multi-block writes': 84,
      'leaf-page overflow keys': 0,
      'maximum blocks required for a page': 1,
      'overflow values written': 0,
      'page reconciliation calls': 96,
      'page reconciliation calls for eviction': 80,
      'pages deleted': 0,
      'pages written including an aggregated newest start durable timestamp ': 225,
      'pages written including an aggregated newest stop durable timestamp ': 0,
      'pages written including an aggregated newest stop timestamp ': 0,
      'pages written including an aggregated newest stop transaction ID': 0,
      'pages written including an aggregated newest transaction ID ': 225,
      'pages written including an aggregated oldest start timestamp ': 225,
      'pages written including an aggregated prepare': 0,
      'pages written including at least one prepare': 0,
      'pages written including at least one start durable timestamp': 7329,
      'pages written including at least one start timestamp': 7329,
      'pages written including at least one start transaction ID': 7329,
      'pages written including at least one stop durable timestamp': 0,
      'pages written including at least one stop timestamp': 0,
      'pages written including at least one stop transaction ID': 0,
      'records written including a prepare': 0,
      'records written including a start durable timestamp': 255420,
      'records written including a start timestamp': 255420,
      'records written including a start transaction ID': 255420,
  ...
  count: 250000,
  numOrphanDocs: 0,
  storageSize: 189739008,
  totalIndexSize: 74579968,
  totalSize: 264318976,
  indexSizes: {
    _id_: 6983680,
    trackno: 17899520,
    fromOnToRef: 33308672,
    on: 16388096
  },
  avgObjSize: 1402,
  ns: 'shipdb.delivery',
