// Current Mongosh Log ID:	6778ea7d0378a23d19fe6910
...
// Enterprise sccamp[primary] shipdb >
{
  ...
  wiredTiger: {
    ...
    type: 'file',
    uri: 'statistics:table:collection-42-7440438102761067881',
    LSM: {
    ...
    'block-manager': {
      'allocations requiring file extension': 708,
      'blocks allocated': 862,
      'blocks freed': 133,
      'checkpoint size': 23121920,
      'file allocation unit size': 4096,
      'file bytes available for reuse': 233472,
      'file magic number': 120897,
      'file major version number': 1,
      'file size in bytes': 23371776,
      'minor version number': 0
    },
    btree: {
      'btree checkpoint generation': 2087,
    ...
    cache: {
      'bytes currently in the cache': 54279158,
      'bytes dirty in the cache cumulative': 10688008,
      'bytes read into cache': 56689654,
      'bytes written from cache': 65248890,
      ...
      'eviction walk passes of a file': 2965,
      'eviction walk target pages histogram - 0-9': 1228,
      'eviction walk target pages histogram - 10-31': 1698,
      'eviction walk target pages histogram - 128 and higher': 0,
      'eviction walk target pages histogram - 32-63': 39,
      'eviction walk target pages histogram - 64-128': 0,
      'eviction walk target pages reduced due to history store cache pressure': 0,
      'eviction walks abandoned': 29,
      'eviction walks gave up because they restarted their walk twice': 1328,
      'eviction walks gave up because they saw too many pages and found no candidates': 9,
      'eviction walks gave up because they saw too many pages and found too few candidates': 6,
      'eviction walks random search fails to locate a page, results in a null position': 0,
      'eviction walks reached end of tree': 2994,
      'eviction walks restarted': 0,
      'eviction walks started from root of tree': 1380,
      'eviction walks started from saved location in tree': 1585,
      ...
      'leaf pages split during eviction': 108,
      'locate a random in-mem ref by examining all entries on the root page': 1,
      'modified pages evicted': 109,
      ...
      'pages read into cache': 699,
      'pages read into cache after truncate': 0,
      'pages read into cache after truncate in prepare state': 0,
      'pages requested from the cache': 251436,
      'pages seen by eviction walk': 118361,
      'pages written from cache': 850,
      'pages written requiring in-memory restoration': 107,
    ...
    'checkpoint-cleanup': {
      ...
      'pages removed': 0,
      'pages skipped during tree walk': 2185,
      'pages visited': 2656
    },
    compression: {
      'compressed page maximum internal page size prior to compression': 4096,
      'compressed page maximum leaf page size prior to compression ': 101588,
      'compressed pages read': 699,
      'compressed pages written': 820,
    ...
    cursor: {
      ...
      'insert calls': 250000,
      'insert key and value bytes': 52542790,
      modify: 0,
    ...
    reconciliation: {
      ...
      'approximate byte size of timestamps in pages written': 4079840,
      'approximate byte size of transaction IDs in pages written': 2039920,
      'dictionary matches': 0,
      'fast-path pages deleted': 0,
      'internal page key bytes discarded using suffix compression': 1519,
      'internal page multi-block writes': 5,
      'leaf page key bytes discarded using prefix compression': 0,
      'leaf page multi-block writes': 110,
      'leaf-page overflow keys': 0,
      'maximum blocks required for a page': 1,
      'overflow values written': 0,
      'page reconciliation calls': 122,
      'page reconciliation calls for eviction': 107,
      'pages deleted': 0,
      'pages written including an aggregated newest start durable timestamp ': 23,
      'pages written including an aggregated newest stop durable timestamp ': 0,
      'pages written including an aggregated newest stop timestamp ': 0,
      'pages written including an aggregated newest stop transaction ID': 0,
      'pages written including an aggregated newest transaction ID ': 23,
      'pages written including an aggregated oldest start timestamp ': 23,
      'pages written including an aggregated prepare': 0,
      'pages written including at least one prepare': 0,
      'pages written including at least one start durable timestamp': 734,
      'pages written including at least one start timestamp': 734,
      'pages written including at least one start transaction ID': 734,
      'pages written including at least one stop durable timestamp': 0,
      'pages written including at least one stop timestamp': 0,
      'pages written including at least one stop transaction ID': 0,
      'records written including a prepare': 0,
      'records written including a start durable timestamp': 254990,
      'records written including a start timestamp': 254990,
      'records written including a start transaction ID': 254990,
  ...
  count: 250000,
  numOrphanDocs: 0,
  storageSize: 23371776,
  totalIndexSize: 12587008,
  totalSize: 35958784,
  indexSizes: { _id_: 7053312, timestamp: 5533696 },
  avgObjSize: 206,
  ns: 'shipdb.payment',
  nindexes: 2,
  scaleFactor: 1
